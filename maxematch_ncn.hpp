/* Maximal edge matching using MPI-3 Neighborhood Nonblocking Collectives */

#pragma once
#ifndef MAXEMATCHNCN_HPP
#define MAXEMATCHNCN_HPP
...
class MaxEdgeMatchNCN
{
    public:
        MaxEdgeMatchNCN(Graph* g): 
            g_(g), D_(0), M_(0), 
            ...
            sdispls_(0), rdispls_(0)
        {
            ...
            for (int t = 0; t < outdegree_; t++)
            {
                ...
                disp += (nghosts_in_target_[targets_[t]]*3*2); 
            }
    ...
    private:
        ...
        std::unordered_map<int, GraphElem> 
            nghosts_in_target_, pindex_; // ghost vertices in target rank
